...
const Edit = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      // Check if the new username is different from the current and if it's already taken
      if (username !== user.username) {
        ...
        if (!usernameInput.data.isAvailable) {
          ...
          return; // Stop the update if the username is not available
        }
      }

      // Check if the new email is different from the current and if it's already taken
      if (email !== user.email) {
    ...
    <div className="edit-profile-page">
      ...
      <div className="profile-image-section">
        <div className="profile-image-container">
          {/* Set profile image to Account Logo if user doesn't add new profile image */}
      ...
      <div className="form-section">
        ...
        <center><button onClick={handleSave}>Save Changes</button></center><br/>
      </div>
    </div>
  );
};
